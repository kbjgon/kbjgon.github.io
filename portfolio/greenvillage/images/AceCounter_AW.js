...
if( _rl.indexOf(';') > 0){var _ttRL=_rl;var _spt1 = _rl.indexOf(';');var _spt2 = _rl.indexOf('?');if(_spt1 < _spt2){_ttRL= _ttRL.substr(0,_spt1);_rl= _ttRL+_rl.substr(_spt2,_rl.length-_spt1);}else{_rl = _rl.substr(0,_spt1);}};
_PL(_rl); // Site Logging
} }
var _TOAST=(function(tp,u){var si=new Image(0,0),dv='ACEUCI'+tp+'=1',dc=document,lpt=((location.protocol=='https:')?'https:':'http:');if(String(document.cookie).indexOf('ACEUCI'+tp+'=')==-1){si.src=lpt+'//adlc-exchange.toast.com/sendid?sid=acecounter&uid='+u+'&rnd='+Math.random();};dc.cookie=dv+';';return si;})('','1541570346647125773');
